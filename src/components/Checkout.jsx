...
export default function Checkout() {
	...
	const orderCollection = collection(FirebaseDB, 'orders');

	const { cart, valorTotalCarrito , limpiarCarrito} = useContext(MiContexto);
		...
		<>
			{!orderId ? (
				...
				<div
					...
					id='orderForm'>
					<h2 className='text-warning'>Gracias por su compra!</h2>
					<p className='mt-2'>
						Para cualquier eventual consulta: contacto@algoritmia.com
					</p>
